		...
		{  
			...
			n2=(node)q.dequeue();
			    ...
			    q.enqueue(ntemp);
                           ...
                           System.out.println("NODE NOT FOUND:"+n1.getids()+":"+n2.getids());
                        }
                        ...
                        else if(n2.getprikey()!=0)
                        {
                           ...
                           System.out.println("NODE NOT FOUND:"+ntemp);
                }  
           if(q.size()>=1)
            root=(node)q.dequeue();
           else
            ...
            setdepths(rcopy,0,rcopy);
                  ...
                  else if(nshallow.getprikey()==0&&nnew.getprikey()==0)
                  {
                         ...
                         if(tmp!=null)
                         {
                           ...
                           System.out.println("NODE NOT FOUND:"+nshallow.getids()+":"+nnew.getids());
                  }
                  else
                     System.out.println("NODE NOT FOUND:"+ntemp);
