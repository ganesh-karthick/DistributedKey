   ...
   member me;
        ...
        public group getgroup(String id)
	{
        ...
        synchronized public void startkeydaemonforid(String id)  //startz key daemon for the groups containing given id
        {
         ...
         synchronized public void startkeydaemonforgroup(String id)  //startz key daemon for the groups containing given id
        {
            Object ogrp[]=v.toArray();
        ...
        synchronized public void stopkeydaemonforgroup(String id)  //startz key daemon for the groups containing given id
        {
            Object ogrp[]=v.toArray();
